...
class CouponViewModel(
    ...
    private fun getCoupon(){
        ...
        viewModelScope.launch {
            ...
            _coupons.value = when(val result = repository.getCoupon("Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc19wYXJ0bmVyIjowLCJ1c2VySWQiOjIwMjEwMzAwMDEzLCJpYXQiOjE2MTkyODkxMzZ9.JHNdIzBf37u2i3v0zYJ-iZj2Zrh5BnSPKDwdLFBjLlk", CouponType.ALL.value)) {
