...
class PerformanceAdapter :
    ListAdapter<Performance, PerformanceAdapter.PerformanceViewHolder>(PerformanceDiffCallbackUtil) {
    ...
    class PerformanceViewHolder(private val binding: ItemPerformanceBinding) :
